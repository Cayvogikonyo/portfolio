                    ...
                    <div class="my-6 px-3 transition duration-500 ease-in-out transform hover:-translate-y-1 hover:scale-105">
                        <div class="bg-white rounded shadow">
                            <a href="{{url('/work/'.$work->slug)}}">
                                <img src="<?php if(!empty($work->header)){ echo $work->header; } else echo '/randoms/'.$work->randomHeader();  ?>" class="mx-auto opacity-100 transition duration-500 ease-in-out hover:opacity-50" alt="{{$work->header_alt}}">
                            </a>
