                    ...
                    <div class="flex flex-wrap">
                        ...
                        <div class="w-full md:w-1/2 py-3">
                            ...
                            <div :key="index" class="flex flex-wrap" v-for="(item, index) in form.collaborators">
                                <span class="block rounded-full mx-3 w-24 h-24"
                                    :style="'background-size: cover; background-repeat: no-repeat; background-position: center center; background-image: url(\'' + item.avatarUrl+ '\');'">
                                </span>
                                <div>
                        ...
                        <div class="w-full md:flex" v-if="form.portofolio_id">
                            <div class="w-full md:w-1/2 p-3" >
                                ...
                                <jet-dialog-modal :show="addingSkills" @close="addingSkills = false">
                                    ...
                                    <template #content>
                                        <add-skill :skills="portofolios[portofolioIndex].skills" :selectedSkills="skills" v-on:skip="addingSkills = false" v-on:skill="attachSkill"/>
                                    </template>
                            ...
                            <div class="w-full md:w-1/2 p-3" >                           
                                ...
                                <jet-dialog-modal :show="addingService" @close="addingService = false">
                                    ...
                                    <template #content>
                                        <add-service :services="portofolios[portofolioIndex].services" :selectedservices="services" v-on:skip="addingService = false" v-on:service="attachService"/>
                                    </template>
                            ...
                            <div class="w-full md:w-1/2 p-3" >
                                ...
                                <jet-dialog-modal :show="addingClient" @close="addingClient = false">
                                    ...
                                    <template #content>
                                        <add-client :clients="portofolios[portofolioIndex].clients" :selectedclients="clients" v-on:skip="addingClient = false" v-on:client="attachClient"/>
                                    </template>
