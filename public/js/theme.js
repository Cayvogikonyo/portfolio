...
function scrollDown() {
  document.getElementById('sectioncontent').scrollIntoView({
    behavior: 'smooth'
  });
}
/****
...
var buttons = document.getElementsByClassName('pop-prop');
var tooltip = null;
var attach = null;
...
function create() {
  if (attach !== null) {
    ...
    popperInstance = (0,_popperjs_core__WEBPACK_IMPORTED_MODULE_0__.createPopper)(attach, tooltip, {
      placement: place,
      modifiers: [{
        name: 'offset',
        options: {
