...
export default {
  components: { Button },
    ...
    data(){
        return {
            form: this.$inertia.form({
                ...
                site_header: this.siteconfig.site_header,
                name: this.siteconfig.name,
                subtitle: this.siteconfig.subtitle,
                title: this.siteconfig.title,
                bio: this.siteconfig.bio
            }, {
                bag: 'updateSiteInformation',
            }),
            editTitle: false,
            editBio: false,
            editSubtitle: false,
    ...
    computed:{
        hasChange(){
            if(this.siteconfig.name !== this.form.name){
                return true;
            }
            if(this.siteconfig.title !== this.form.title){
                return true;
            }
            if(this.siteconfig.subtitle !== this.form.subtitle){
                return true;
            }
            if(this.siteconfig.site_header !== this.form.site_header){
                return true;
            }
            if(this.siteconfig.bio !== this.form.bio){
                return true;
            }
