        ...
        @include('includes.sidebar')
         ...
         <div class="min-h-screen bg-gray-100 dark:bg-gray-900 sm:items-center sm:pt-0 clearfix">
            <nav class="bg-white dark:bg-gray-900 dark:shadow-none p-3 text-black dark:text-white flex justify-between">
                ...
                <button id="themebtn" title="Theme" class="text-lg text-black dark:text-white underline font-bold px-3 p-1 transition duration-500 ease-in-out transform hover:-translate-y-1 hover:scale-110"><i class="fas fa-sun" id="themeIcon"></i></button>
            </nav>
